...
export const ui = {
    ...
    get styleCellBottomStrokeStyleInput() { return byId<HTMLSelectElement>('style-cell-bottom-stroke-style'); },
    ...
    get styleCellBottomColorPreview() { return byId<HTMLElement>('style-cell-bottom-color-preview'); },
