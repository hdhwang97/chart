...
export const ui = {
    ...
    get rowColorModeSelect() { return byId<HTMLSelectElement>('row-color-mode-select'); },
    get rowColorHexInput() { return byId<HTMLInputElement>('row-color-hex-input'); },
    get rowColorModeFieldLabel() { return byId<HTMLElement>('row-color-mode-field-label'); },
